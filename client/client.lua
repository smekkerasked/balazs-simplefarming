  ...
  exports.rprogress:Custom({
    ...
    onComplete = function(cancelled)
      if not cancelled then
        TriggerServerEvent("balazs-simplefarmingzone:server:additem", Source, Activ.rewards)
      end
      FinishedFrarming()
    end
  })
...
RegisterNetEvent('balazs-simplefarming:notify')
AddEventHandler('balazs-simplefarming:notify', function(text, length, type)
